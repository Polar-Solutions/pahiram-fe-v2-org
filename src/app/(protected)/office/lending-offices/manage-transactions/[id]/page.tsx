...
import ReturnTransacSpecific from "@/components/transaction/presentational/return-transaction/return-transac-specific";
...
export default function Page({ params }: { params: { id: string } }) {
  return (
    <ContentLayout title="Specific Transaction">
      ...
      />
      <Content>
        <ReturnTransacSpecific transactionId={params.id} />
      </Content>
    </ContentLayout>
  );
}
