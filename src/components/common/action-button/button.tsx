...
export default function ActionButton({ approveText, declineText, onApprove, onDecline }: ActionButtonsProps) {
  return (
    <div className='flex gap-2'>
        <Button onClick={onApprove}>
            <svg width="15" height="15" viewBox="0 0 15 15" className="mr-2"  fill="none" xmlns="http://www.w3.org/2000/svg">
