...
import {checkTransactionStatus, formatBorrowPurpose, formatBorrowStatus} from '@/helper/formatting-utilities';
                            ...
                            <p className="text-sm text-muted-foreground flex items-center">
                                {(() => {
                                    const {
                                        formattedStatus,
                                        badgeClass
                                    } = formatBorrowStatus(transactionData.transac_data.transac_status);
                                    return (
                                ...
                                <span
                                    className="ml-2">on {formatDateTimeToHumanFormat(transactionData.transac_data.updated_at)}</span>
                            </p>
                        </div>
                            ...
                            <Dialog>
                                ...
                                <DialogContent className="sm:max-w-[425px]">
                                    <DialogHeader>
                                        ...
                                        <DialogDescription>
                                            Are you sure you want to cancel this request? This is an irreversible
                                            action.
                                        </DialogDescription>
                                    </DialogHeader>
                                    <DialogFooter>
