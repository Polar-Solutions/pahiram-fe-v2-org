import {PURPOSE_CONSTANTS, PURPOSE_CONSTANTS_KEYS} from "@/CONSTANTS/PURPOSE_CONSTANTS";
import {z} from "zod";

const PurposeSchema = z
    .union([z.enum(PURPOSE_CONSTANTS_KEYS as [string, ...string[]]), z.literal("")])
    .refine(
        (purpose) => purpose !== "",
...
export const BorrowRequestSchema = z
    .object({
        ...
        user_defined_purpose: z.string().min(5, "Purpose must be atleast 5 characters."), // Validates as a non-empty string
        items: z
